...
export default function Dashboard() {
  const [credentials, setCredentials] = useState([
    { id: 1, title: "Gmail", username: "user@gmail.com", category: "Email", lastModified: "2 days ago" },
    { id: 2, title: "GitHub", username: "developer123", category: "Development", lastModified: "1 week ago" },
    { id: 3, title: "AWS Console", username: "admin@company.com", category: "Cloud", lastModified: "3 days ago" },
  ]);
      ...
      <main className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8 py-8">
        ...
        <div className="bg-gray-800 rounded-lg border border-gray-700 p-6 mb-8">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-3 gap-4">
            <button className="p-4 bg-gray-700 rounded-lg hover:bg-gray-600 transition-colors text-left">
              ...
              <div className="text-sm text-gray-400">Create a strong password</div>
            </button>
            <button className="p-4 bg-gray-700 rounded-lg hover:bg-gray-600 transition-colors text-left">
              <div className="text-2xl mb-2">📋</div>
              <div className="text-white font-medium">Import Passwords</div>
              <div className="text-sm text-gray-400">Import from file or browser</div>
            </button>
            <button className="p-4 bg-gray-700 rounded-lg hover:bg-gray-600 transition-colors text-left">
              <div className="text-2xl mb-2">🔍</div>
              <div className="text-white font-medium">Security Checkup</div>
              <div className="text-sm text-gray-400">Scan for weak passwords</div>
            </button>
          </div>
        </div>
        ...
        <div className="bg-gray-800 rounded-lg border border-gray-700 p-6">
          <div className="flex items-center justify-between mb-6">
            <h2 className="text-lg font-semibold text-white">Recent Passwords</h2>
            <input
              type="search"
            ...
            <table className="min-w-full divide-y divide-gray-700">
              ...
              <tbody className="divide-y divide-gray-700">
                {credentials.map((credential) => (
                  <tr key={credential.id} className="hover:bg-gray-700/50 transition-colors">
                    <td className="px-6 py-4 whitespace-nowrap">
                      <div className="text-sm font-medium text-white">{credential.title}</div>
                    </td>
                    <td className="px-6 py-4 whitespace-nowrap">
                      <div className="text-sm text-gray-300">{credential.username}</div>
                    </td>
                    <td className="px-6 py-4 whitespace-nowrap">
          ...
          {credentials.length === 0 && (
            <div className="text-center py-12">
              ...
              <button className="mt-4 btn btn-primary">Add Your First Password</button>
            </div>
          )}
        </div>
      </main>
